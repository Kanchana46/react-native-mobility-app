...
const RideOptionsCard = () => {
    ...
    return (
        <SafeAreaView style={tw`bg-white flex-grow`}>
            ...
            <Text style={tw`text-center text-xl`}>Select a Ride - {travelTimeInfo?.distance.text}</Text>
            <FlatList
                data={data}
            ...
            <View>
                <TouchableOpacity disabled={!selected}
                    style={tw`bg-black py-3 my-4 mx-3 ${!selected && "bg-gray-300"}`}>
